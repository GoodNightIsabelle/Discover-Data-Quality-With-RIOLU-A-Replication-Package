...
def coverage_estimation(source_column, coverage_threshold):
    ...
    generator = PatternGenerator(source_column, coverage_threshold, constrained_temp=False)
...
for _ in range(5):
    ...
    for dataset in datasets:
        ...
        for column in gt_columns:
            ...
            generator = PatternGenerator(filtered_list, coverage_threshold, constrained_temp=False)
            generator.pattern_coverage_statictics()
